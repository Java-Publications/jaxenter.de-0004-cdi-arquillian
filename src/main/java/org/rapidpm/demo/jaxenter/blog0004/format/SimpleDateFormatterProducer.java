...
package org.rapidpm.demo.jaxenter.blog0004.format;
...
import org.rapidpm.demo.jaxenter.blog0004.locale.LocaleResolver;
import org.rapidpm.demo.jaxenter.blog0004.property.PropertyResolver;
...
public class SimpleDateFormatterProducer {
    ...
    public SimpleDateFormat createDefault(InjectionPoint injectionPoint) {
        final String ressource = propertyResolver.resolveProperty("date.default");
    ...
    public java.text.SimpleDateFormat produceSimpleDateFormatter(InjectionPoint ip) {
        ...
        if (present) {
            ...
            final String ressource = propertyResolver.resolveProperty(ressourceKey);
